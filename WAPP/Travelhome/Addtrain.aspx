<%@ Page Title="" Language="C#" MasterPageFile="~/mp.master" AutoEventWireup="true" CodeFile="Addtrain.aspx.cs" Inherits="Addtrain" %>
    ...
    <div class="row">
        <div class="col-md-offset-3 col-md-6">
            <form class="form-horizontal" runat="server">
               <center> <span class="heading"><font size="30">Add Train times</font> </span></center>
                <div class="form-group">
                   <center> <p></p>
                       <asp:Label ID="Label1" runat="server" Text="Train number"></asp:Label>
                       &nbsp;<asp:TextBox ID="txttrainno" runat="server"></asp:TextBox></center>
                </div><p></p>
