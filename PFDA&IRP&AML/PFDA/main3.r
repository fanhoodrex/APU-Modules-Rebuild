...
Hourly.weather.data$wind_gust = ifelse(is.na(Hourly.weather.data$wind_gust),
                                       ave(Hourly.weather.data$wind_gust,
                                           FUN = function(x) 
                                             mean(x, na.rm = 'TRUE')),
                                       Hourly.weather.data$wind_gust)
...
ggplot(Hourly.weather.data, mapping = aes(x = 1, y = wind_speed, fill = wind_speed)) + 
...
Hourly.weather.data$wind_speed=outlier_norm(Hourly.weather.data$day)
ggplot(Hourly.weather.data, mapping = aes(x = 1, y = wind_speed, fill = wind_speed)) + 
