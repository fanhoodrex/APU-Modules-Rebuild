<%@ Page Title="" Language="C#" MasterPageFile="~/mp.master" AutoEventWireup="true" CodeFile="adminviewtrain.aspx.cs" Inherits="adminviewtrain" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <center><h1>All train order</h1></center><p></p>
    <center><table class"w-100" border="1" style="background-color:#FFFFFF; width: 959px;">
      <tr style="font-weight:bold;">
          <td style="height: 26px">ID number</td>
          <td style="height: 26px">Train number</td>
