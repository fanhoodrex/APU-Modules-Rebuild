<%@ Page Title="" Language="C#" MasterPageFile="~/mp.master" AutoEventWireup="true" CodeFile="viewair.aspx.cs" Inherits="viewair" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <center><h1>Airline list</h1></center><p></p><p></p><p></p>
    <center><table class"w-100" border="1" style="background-color:#FFFFFF; width: 959px;">
     <%= strairlineDetails %>
    </table></center>
    <p></p>
    <p></p>
   <center> <p>Notication: Please enter the airline number which you want.</p>
    ...
    <p>Before purchase please check the status</p>
     ...
     <form class="form-horizontal" runat="server">
        ...
        <asp:Label ID="Label1" runat="server" Text="Airline number"></asp:Label>
     &nbsp;&nbsp;&nbsp;
     <asp:TextBox ID="txtairlinenum" runat="server"></asp:TextBox></center>
</div><p></p>
         <div class="form-group"> <center>
