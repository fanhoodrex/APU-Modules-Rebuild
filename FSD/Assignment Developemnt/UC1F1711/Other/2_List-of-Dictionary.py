...
def create_profile():
    ...
    while True:
        ...
        if profile_type == 1 :
            ...
            Academic_leader = {} # initialize empty dictionary for individual lecturer
            ...
            for attribute in ['name','age','gender','teaching subject','enrollment date']: # using for clause to loop through the list of every profile attribute
                ...
                Academic_leader[attribute] = data # append the each attribute element to individual lecturer list
            ...
            for attribute in ['name','age','gender','teaching subject','enrollment date']: # using for clause to loop through the list of every profile attribute
                data = input(f"Pls enter the {attribute} for the lecture:") # f string to catch user input for profile attributes
                Lecturer[attribute] = data # append the each attribute element to individual academic leader list
            ...
            print("Done finishing creating all profiles !!! ")
            time.sleep(1)    
            break
...
def main():
    ...
    with open("List-of-Dictionary.txt",'w') as f:
